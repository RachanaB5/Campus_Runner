  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden h-44 flex-shrink-0">
        ...
        {/* Veg badge */}
        <div className={`absolute top-2.5 left-2.5 rounded-full p-1.5 shadow ${item.isVeg ? "bg-green-500" : "bg-red-500"}`}>
          {item.isVeg
        ...
        {/* Rating badge */}
        <div className="absolute top-2.5 right-2.5 bg-white/90 backdrop-blur-sm rounded-full px-2 py-1 shadow flex items-center gap-1">
