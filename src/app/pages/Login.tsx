    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Campus Runner</h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  />
                </div>
              </div>
            )}
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
            )}

            {!isLogin && (
              <div className="flex items-start gap-3 mt-4 p-4 bg-orange-50/70 border border-orange-100 rounded-lg">
                <input
                  type="checkbox"
                  id="isRunner"
                  checked={isRunner}
                ...
                <div className="flex flex-col">
                  <label htmlFor="isRunner" className="text-sm text-gray-900 font-semibold cursor-pointer">
                    Sign up as a Delivery Runner
                  </label>
                  <span className="text-xs text-gray-600">Deliver food on campus and earn points!</span>
                </div>
              </div>
            )}

            <div>
              <label className="block text-sm font-semibold text-gray-900 mb-2">RV University Email</label>
              <div className="relative">
